...
#python ./semantic_search.py -q "carta para carla" -d happy -d sad -s
...
def semantic_search(engine, query, documents):
    ...
    print("scorer:")
    print ( [scorer.get_context() for scorer in scorers] )
    print("FIN:")
...
def main():
    print("caracola")
    openai.api_key = "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"
